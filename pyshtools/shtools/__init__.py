...
_not_finished = ['SHPowerL',
                 ...
                 'SHAdmitCorr', 'SHConfidence', 'SHPowerLC',
                 'SHPowerDensityLC', 'SHCrossPowerLC', 'SHCrossPowerDensityLC',
                 'SHPowerSpectrumC', 'SHPowerSpectrumDensityC',
                 'SHCrossPowerSpectrumC', 'SHCrossPowerSpectrumDensityC',
                 'SHMultiTaperSE', 'SHMultiTaperCSE', 'SHLocalizedAdmitCorr',
                 'SHReturnTapers', 'SHReturnTapersM', 'ComputeDm',
                 'ComputeDG82', 'SHFindLWin', 'SHBiasK', 'SHMTCouplingMatrix',
                 'SHBiasAdmitCorr', 'SHMTDebias', 'SHMTVarOpt', 'SHSjkPG',
                 'SHMultiTaperMaskSE', 'SHMultiTaperMaskCSE',
                 'SHReturnTapersMap', 'SHBiasKMask', 'ComputeDMap',
                 'Curve2Mask', 'SHBias', 'SphericalCapCoef', 'djpi2',
                 'SHRotateCoef', 'SHRotateRealCoef', 'MakeGravGridDH',
