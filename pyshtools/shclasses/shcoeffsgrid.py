...
class SHGrid(object):
    ...
    def to_netcdf(self, filename=None, title='', description='',
                  comment='Grid generated by pyshtools', name='data',
                  long_name='', units='', dtype=None):
        """
    ...
    def plot_gmt(self, figure=None, projection='mollweide', region='g',
                 ...
                 cb_tick_interval=None, horizon=60, shift_origin=[0, 0],
                 fname=None):
        """
        ...
        fig = x.plot_gmt([figure, projection, region, width, unit, latitude,
                          ...
                          cb_tick_interval, horizon, shift_origin, fname])
