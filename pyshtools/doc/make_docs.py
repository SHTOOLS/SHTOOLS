...
def main():
    ...
    with open(os.path.join(pydocfolder, 'meson.build'), 'w') as mesonfile:
        mesonfile.write('# AUTOGENERATED FILE; run `make doc` to update\n')
        mesonfile.write('doc_files = [\n')
        for doc in sorted(doc_files):
            mesonfile.write(f"  '{doc}',\n")
        mesonfile.write("""]

install_data(
  doc_files,
  install_dir: python.get_install_dir(subdir: 'pyshtools/doc'),
  install_tag: 'doc')
""")

    print('meson doc file list updated successfully')
