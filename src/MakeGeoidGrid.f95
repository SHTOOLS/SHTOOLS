...
!-------------------------------------------------------------------------------
    ...
    ! Create Grid B 
    do l = 0, lmax_comp
        cilm2(1:2,l+1,1:l+1) = -(GM/r**2) * dble(l+1) * cilm1(1:2,l+1,1:l+1) &
                                * (r0pot/r)**l
    end do
    ...
    if (order == 2 .or. order == 3) then
        ...
        do l = 0, lmax_comp
            cilm2(1:2,l+1,1:l+1) = GM/(2.0d0*r**3) * dble(l+1) * dble(l+2) &
    ...
    if (order == 3) then
        ...
        do l = 0, lmax_comp
            cilm2(1:2,l+1,1:l+1) = -GM/(6.0d0*r**4) * dble(l+1) * dble(l+2) &
                                    * dble(l+3) * &
                                    cilm1(1:2,l+1,1:l+1) * (r0pot/r)**l
        end do
    ...
    if (order == 1) then
        ...
        geoid(1:nlat,1:nlong) = pp(1:nlat,1:nlong) / 3.0d0 / &
            &uu(1:nlat,1:nlong) - uu(1:nlat,1:nlong) - gridc(1:nlat,1:nlong) &
