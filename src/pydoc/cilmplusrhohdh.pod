...
=item SUBROUTINE CilmPlusRhoHDH ( 

CILM, GRIDIN, LMAX, NMAX, MASS, D, RHO, SAMPLING, N )
...
1 = Equally sampled Driscoll-Healy grids, NxN, calculated using I<MakeGridDH>. 2 (default) = Equally spaced Driscoll-Healy grids, Nx2N, calculated using I<MakeGridDH>.
...
cilmplus(1), shexpandglq(1), makegridglq(1), shglq(1), preglq(1), glqgridcoord(1), makegriddh(1)
