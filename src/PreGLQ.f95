...
!-------------------------------------------------------------------------------
    ...
    xu = (x2 - x1) / 2.0d0  ! Scaling factor between interval of integration, 
                            ! and that of the -1 to 1 interval for the 
                            ! Gauss-Legendre interval
    ...
    do i = 1, m 
        ...
        do
            ...
            do j = 1, n     ! determine the legendre polynomial evaluated at 
                            ! z (p1) using recurrence relationships
                p3 = p2
                p2 = p1
            ...
            pp=dble(n)*(z*p1-p2) / (z*z-1.0d0)  ! This is the derivative of 
