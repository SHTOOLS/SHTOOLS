subroutine MakeMagGridDH(cilm, lmax, r0, a, f, rad_grid, theta_grid, phi_grid, &
                            total_grid, n, sampling, lmax_calc, pot_grid)
!-------------------------------------------------------------------------------
!
!   Given the Schmidt normalized magnetic potential spherical harmonic 
