...
!   degree l corresponding to the complex spherical harmonic coefficients 
!   c(i, l, m)
!
...
!   (density) at degree l of the complex spherical harmonic coefficients 
!   c(i, l, m)
!
...
!-------------------------------------------------------------------------------
    ...
    else if (size(c2(:,1,1)) < 2 .or. size(c2(1,:,1)) < l1 .or. size(c2(1,1,:)) < l1) then
...
!   (density) at degree l of the complext spherical harmonic coefficients 
...
!
!   This function will compute the dimensionless cross power spectrum
!   density of the complex spherical harmonic coefficients c1(i, l, m) and 
!   c2(i,l,m).
!
!   CrossPower(l) =  Sum_{m=0}^l ( C11lm*C21lm^* + C12lm*C22lm^* ) / (2l+1)
!
