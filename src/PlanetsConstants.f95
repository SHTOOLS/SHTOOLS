...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	real*8, parameter ::	Grav_constant = 6.67384d-11, &	! CODATA, Mohm and Taylor (2012)
				pi_constant =  3.14159265358979
	real*8, parameter ::	mu0_constant = pi_constant * 4.0d-7		! magnetic constant
	
	! Moon
	
	real*8, parameter ::	R_Moon = 1737151.198265080d0, &	! degree-0 term of the LOLA model LOLA2600p.sh
	...
	real*8, parameter ::	g0_Mars = GM_Mars/R_Mars**2, &		! gravitational acceleration at R_Mars, not including rotation.&
	...
	real*8, parameter ::	GM_Mercury = 22031.839224134801e+09, & ! model ggmes_20v04_sha available on the PDS
