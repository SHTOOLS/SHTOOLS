...
1 = Gauss-Legendre grids, calculated using `SHGLQ` and I<MakeGridGLQ>. 2 = Equally sampled Driscoll-Healy grids, NxN, calculated using I<MakeGridDH>. 3 = Equally spaced Driscoll-Healy grids, Nx2N, calculated using I<MakeGridDH>.
