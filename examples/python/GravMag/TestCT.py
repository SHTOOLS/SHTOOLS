...
def TestCrustalThickness():
	...
	bc, d = shtools.CilmPlusDH(topo_grid,nmax,mass,rho_c,lmax=lmaxp)
	print d
	ba = pot - bc
	...
	moho_c = shtools.HilmDH(ba,moho_grid3,nmax,mass,r0,(rho_m-rho_c),lmax=lmax,filter_type=filter_type,filter_deg=half,lmax_calc=degmax)
